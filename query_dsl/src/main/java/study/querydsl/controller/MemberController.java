...
public class MemberController {
    ...
    public List<MemberTeamDto> searchMemberV1(MemberSearchCondition memberSearchCondition) {
        return memberJpaRepository.searchByBooleanBuilder(memberSearchCondition);
    }
    ...
    public Page<MemberTeamDto> searchMemberV4(MemberSearchCondition memberSearchCondition, Pageable pageable) {
        return memberRepository.searchPageComplexExecutionUtils(memberSearchCondition,pageable);
    }
}
